...
#define L3 D6
#define L4 D7
#define Fan "16A31CC8CB7D431781094B0AA988B3E8"  //Device Id/Key
#define Light1 "2A0C69DA9EE84894B48C2FFA76487BB0"  //Device Id/Key
#define Light2 "75804E32D5E04349A0F90E975B380253"  //Device Id/Key
#define MoonLight "1C8464626D164259A91A9507F9A0B1A5"  //Device Id/Key
...
char message[3600];
#define DeviceSize 4
String deivcesId[DeviceSize] = {Fan, Light1, Light2, MoonLight}; //
...
void turnOff(String deviceId) {
  if (deviceId == Fan)
  {
    Serial.println("Turn Off Device ID: Bedroom Fan: ");
...
void turnOn(String deviceId) {
    if (deviceId == Fan)
    {
        Serial.println("Turn ON Device ID: Bedroom Fan: ");
