...
namespace IoT.DataLayer.Migrations
{
    ...
    [Migration("20210819061401_UpdateDeviceRookKeyToRoomId")]
    partial class UpdateDeviceRookKeyToRoomId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoT.DataLayer.Models.Device", b =>
                {
                    b.HasOne("IoT.DataLayer.Models.DeviceType", null)
                        .WithMany("Devices")
                        .HasForeignKey("DeviceTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IoT.DataLayer.Models.Room", null)
                        .WithMany("Devices")
